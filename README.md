...
### 👋 안녕하세요, UX/UI 디자이너 출신 Frontend-Engineer 김채린입니다.
사용자 경험부터 기술 구조와 성능까지 제품 전반을 고민하며 개발합니다.
- SARA·비영리 플랫폼 — 서비스 아키텍처를 설계하고 구축했습니다.
- 디자인 시스템 — 구축과 성능 최적화를 맡아 빌드·배포 구조를 개선하고, 테스트 앱의 JS 번들을 66% 줄였습니다. AI 기반 PR 리뷰 자동화에 이어 Vitest로 주요 동작을 검증해 반복적인 수동 리뷰를 대체했습니다.
- 사업보고서 — Playwright 기반 E2E 테스트를 도입해 9개 이상 고객사의 반복적인 수동 검증을 자동화했습니다.
<br>
...
- **Build & Monorepo** · Rollup, Nx, pnpm
- **API & Data** · GraphQL, MySQL, MongoDB, Supabase
- **Collaboration** · Git, GitHub, Azure Pipelines, Figma, Slack, Notion
